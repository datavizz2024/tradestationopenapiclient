...
class AskQuote(BaseModel):
    ...
    size: Optional[StrictStr] = Field(None, alias="Size", description="The total number of shares offered by this participant for the Ask.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AskQuote:
        """Create an instance of AskQuote from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AskQuote:
        """Create an instance of AskQuote from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AskQuote.parse_obj(obj)

        _obj = AskQuote.parse_obj({
