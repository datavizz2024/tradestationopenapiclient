...
class Balances(BaseModel):
    ...
    balances: conlist(Balance) = Field(None, alias="Balances")
    errors: Optional[conlist(BalanceError)] = Field(None, alias="Errors")
    __properties = ["Balances", "Errors"]
    ...
    def from_dict(cls, obj: dict) -> Balances:
        ...
        _obj = Balances.parse_obj(
            {
                "balances": [Balance.from_dict(_item) for _item in obj.get("Balances")]
                if obj.get("Balances") is not None
                else None,
                "errors": [BalanceError.from_dict(_item) for _item in obj.get("Errors")]
