...
class StreamPositionsErrorResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StreamPositionsErrorResponse:
        """Create an instance of StreamPositionsErrorResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StreamPositionsErrorResponse:
        """Create an instance of StreamPositionsErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StreamPositionsErrorResponse.parse_obj(obj)

        _obj = StreamPositionsErrorResponse.parse_obj({
            "error": obj.get("Error"),
