...
class TrailingStop1(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TrailingStop1:
        """Create an instance of TrailingStop1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TrailingStop1:
        """Create an instance of TrailingStop1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TrailingStop1.parse_obj(obj)

        _obj = TrailingStop1.parse_obj({
