...
class Orders(BaseModel):
    ...
    orders: conlist(Order) = Field(None, alias="Orders")
    errors: Optional[conlist(OrderError)] = Field(None, alias="Errors")
    next_token: Optional[StrictStr] = Field(
        None,
        alias="NextToken",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Orders:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Orders:
        """Create an instance of Orders from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Orders.parse_obj(obj)

        _obj = Orders.parse_obj(
            {
                "orders": [Order.from_dict(_item) for _item in obj.get("Orders")]
                if obj.get("Orders") is not None
                else None,
                "errors": [OrderError.from_dict(_item) for _item in obj.get("Errors")]
