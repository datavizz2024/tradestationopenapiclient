...
class OrderLeg1(BaseModel):
    ...
    expiration_date: Optional[Dict[str, Any]] = Field(None, alias="ExpirationDate", description="The expiration date of the future or option symbol.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderLeg1:
        """Create an instance of OrderLeg1 from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderLeg1:
        """Create an instance of OrderLeg1 from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderLeg1.parse_obj(obj)

        _obj = OrderLeg1.parse_obj({
