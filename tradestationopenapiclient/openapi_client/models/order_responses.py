...
class OrderResponses(BaseModel):
    ...
    orders: Optional[Any] = Field(None, alias="Orders")
    __properties = ["Errors", "Orders"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderResponses:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderResponses:
        """Create an instance of OrderResponses from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderResponses.parse_obj(obj)

        _obj = OrderResponses.parse_obj(
            {
                "errors": [
                    OrderResponse.from_dict(_item) for _item in obj.get("Errors")
                ]
                if obj.get("Errors") is not None
                else None,
                "orders": [
                    OrderResponse.from_dict(_item) for _item in obj.get("Orders")
                ]
