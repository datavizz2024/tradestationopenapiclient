...
class HistoricalOrder(BaseModel):
    ...
    conditional_orders: Optional[conlist(OrderRelationship)] = Field(None, alias="ConditionalOrders", description="Describes the relationship between linked orders in a group and this order.")
    ...
    legs: Optional[conlist(OrderLeg)] = Field(None, alias="Legs", description="An array of legs associated with this order.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HistoricalOrder:
        """Create an instance of HistoricalOrder from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HistoricalOrder:
        """Create an instance of HistoricalOrder from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HistoricalOrder.parse_obj(obj)

        _obj = HistoricalOrder.parse_obj({
            "account_id": obj.get("AccountID"),
            "advanced_options": obj.get("AdvancedOptions"),
            "closed_date_time": obj.get("ClosedDateTime"),
            "commission_fee": obj.get("CommissionFee"),
            "conditional_orders": [OrderRelationship.from_dict(_item) for _item in obj.get("ConditionalOrders")] if obj.get("ConditionalOrders") is not None else None,
            ...
            "legs": [OrderLeg.from_dict(_item) for _item in obj.get("Legs")] if obj.get("Legs") is not None else None,
