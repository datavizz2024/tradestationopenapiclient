...
class OrderConfirmRequestDefinition(BaseModel):
    ...
    osos: Optional[conlist(OrderConfirmRequestDefinitionOSOsInner, min_items=1, unique_items=True)] = Field(None, alias="OSOs")
    legs: Optional[conlist(OrderConfirmRequestDefinitionLegsInner, min_items=1, unique_items=True)] = Field(None, alias="Legs")
    __properties = ["AccountKey", "AdvancedOptions", "AssetType", "Duration", "GTDDate", "LimitPrice", "StopPrice", "OrderType", "Quantity", "Route", "Symbol", "TradeAction", "OSOs", "Legs"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderConfirmRequestDefinition:
        """Create an instance of OrderConfirmRequestDefinition from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderConfirmRequestDefinition:
        """Create an instance of OrderConfirmRequestDefinition from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderConfirmRequestDefinition.parse_obj(obj)

        _obj = OrderConfirmRequestDefinition.parse_obj({
            ...
            "osos": [OrderConfirmRequestDefinitionOSOsInner.from_dict(_item) for _item in obj.get("OSOs")] if obj.get("OSOs") is not None else None,
...
from openapi_client.models.order_confirm_request_definition_osos_inner import OrderConfirmRequestDefinitionOSOsInner
OrderConfirmRequestDefinition.update_forward_refs()
