...
class Quote(BaseModel):
    ...
    net_change_pct: Optional[StrictStr] = Field(None, alias="NetChangePct", description="The percentage difference between the current price and previous day's close, expressed as a percentage. For example, a price change from 100 to 103.5 would be expressed as `\"3.5\"`.")
