...
class ErrorResponse(BaseModel):
    ...
    """
    error: Optional[StrictStr] = Field(None, alias="Error", description="Error Title, can be any of `BadRequest`, `Unauthorized`, `Forbidden`, `TooManyRequests`, `InternalServerError`, `NotImplemented`, `ServiceUnavailable`, or `GatewayTimeout`.")
