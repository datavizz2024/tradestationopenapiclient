...
class OrderConfirmResponseTimeInForce(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderConfirmResponseTimeInForce:
        """Create an instance of OrderConfirmResponseTimeInForce from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderConfirmResponseTimeInForce:
        """Create an instance of OrderConfirmResponseTimeInForce from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderConfirmResponseTimeInForce.parse_obj(obj)

        _obj = OrderConfirmResponseTimeInForce.parse_obj({
