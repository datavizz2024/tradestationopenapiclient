...
class SymbolSearchDefinitionInner(BaseModel):
    """
    ...
    underlying: Optional[StrictStr] = Field(None, alias="Underlying", description="The financial instrument on which an option contract is based or derived.")
    __properties = ["Category", "Country", "Currency", "Description", "DisplayType", "Error", "Exchange", "ExchangeID", "ExpirationDate", "ExpirationType", "FutureType", "MinMove", "Name", "OptionType", "PointValue", "Root", "StrikePrice", "Underlying"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SymbolSearchDefinitionInner:
        """Create an instance of SymbolSearchDefinitionInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SymbolSearchDefinitionInner:
        """Create an instance of SymbolSearchDefinitionInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SymbolSearchDefinitionInner.parse_obj(obj)

        _obj = SymbolSearchDefinitionInner.parse_obj({
