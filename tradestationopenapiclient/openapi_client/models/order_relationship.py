...
class OrderRelationship(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OrderRelationship:
        """Create an instance of OrderRelationship from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OrderRelationship:
        """Create an instance of OrderRelationship from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OrderRelationship.parse_obj(obj)

        _obj = OrderRelationship.parse_obj({
